...
def main():
    ...
    parser.add_argument('--nb_hidden', type=int, default=32,
                        help='number of units in single hidden layer')
    ...
    final_size = 10
    net_layers = [View((flat_dim,)), nn.Linear(flat_dim, args.nb_hidden), nn.ReLU()]
