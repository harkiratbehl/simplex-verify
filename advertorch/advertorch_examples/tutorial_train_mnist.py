...
from advertorch.test_utils import LeNet5, mnist_model_wide, mnist_model_deep
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', default="mnist_model_wide", type=str)
    ...
    if args.mode == "cln":
        ...
        model_filename = args.model_name + str(args.eps) + "_adv.pt"
    else:
        raise
    ...
    if args.model_name == "mnist_model_wide": 
        model = mnist_model_wide()
    elif args.model_name == "mnist_model_deep": 
    ...
    if flag_advtrain:
        ...
        adversary = L1PGDAttack(
            ...
            nb_iter=10, eps_iter=0.25, rand_init=True, clip_min=0.0,
