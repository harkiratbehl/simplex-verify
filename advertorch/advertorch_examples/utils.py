...
TRAINED_MODEL_PATH = os.path.join(DATA_PATH, "advertorch")
...
def cifar_loaders(batch_size):
    ...
    train = datasets.CIFAR10(DATA_PATH, train=True, download=True,
    ...
    test = datasets.CIFAR10(DATA_PATH, train=False, download=True,
