...
declare -a netsArray=("mnist_conv_2_lin" "mnist_conv_2_conv")
for net in ${netsArray[@]}; do
	python examples/mnist.py --epsilon ${eps} --norm_train ${norm_eval} --norm_test ${norm_eval} ${parameters} --model $net &
done

# python examples/mnist.py --epsilon ${eps} --norm_train ${norm_eval} --norm_test ${norm_eval} ${parameters} --model mnist_3layer
# for seed in 159 184 278 292 345 376 432 510 529 538 389 2343 587 610 683 711
# for seed in 159 184 278 292 345 376 432
# do
# 	python examples/mnist.py --epsilon ${eps} --norm_train ${norm_eval} --norm_test ${norm_eval} ${parameters} --model 500 --seed $seed &
# done
