...
class AndersonLinearizedNetwork(LinearizedNetwork):
    ...
    def define_linear_approximation(self, input_domain, int_bounds_provided=False, compute_final_layer=True, n_threads=1, x_idx_max=-1):
    ...
    def compute_pre_activation_bounds(self, x_idx, layer, x_km1_vars, ub_only=False, counterexample_verification=False, single_neuron=False, optimize=True):
        """
